            ...
            <asp:Panel ID="PanelContent" runat="server" CssClass="PageContent">
                ...
                <ul>
                    <li>
                        ...
                        <cms:LocalizedHyperLink ID="lnkOpt1" runat="server" ResourceString="invalidlicense.clientportal" />
                    ...
                    <li>
                        ...
                        <asp:HyperLink ID="lnkOpt2" runat="server" NavigateUrl="mailto:support@kentico.com" Text="support@kentico.com" />.<br />
                    </li>
                    <li>
                        <cms:LocalizedLabel ID="lblOpt3First" runat="server" ResourceString="invalidlicense.howto.option3.firstpart" />
                        <cms:LocalizedHyperLink ID="lnkOpt3" runat="server" ResourceString="invalidlicense.clientportal" />
