<%@ Control Language="C#" AutoEventWireup="true"
    Inherits="CMSInstall_Controls_WizardSteps_SiteCreationDialog"  CodeFile="SiteCreationDialog.ascx.cs" %>
...
<table class="install-wizard-new-site" border="0" cellpadding="0" cellspacing="0" width="100%">
    ...
    <tr style="vertical-align: top;">
        <td colspan="2">
            <cms:CMSRadioButton ID="radWizard" runat="server" GroupName="SiteCreation" />
        </td>
    </tr>
    <tr style="vertical-align: top;">
        <td colspan="2">
            <cms:CMSRadioButton ID="radExisting" runat="server" GroupName="SiteCreation" />
        </td>
    </tr>
</table>
