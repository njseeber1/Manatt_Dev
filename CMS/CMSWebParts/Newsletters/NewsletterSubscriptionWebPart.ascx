        ...
        <div class="form-horizontal">
            <asp:PlaceHolder runat="server" ID="plcFirstName">
                <div class="form-group">
                    ...
                    <div class="editing-form-value-cell">
                        <cms:CMSTextBox ID="txtFirstName" runat="server" MaxLength="200" />
                    </div>
                </div>
            </asp:PlaceHolder>
            <asp:PlaceHolder runat="server" ID="plcLastName">
                <div class="form-group">
                    ...
                    <div class="editing-form-value-cell">
                        <cms:CMSTextBox ID="txtLastName" runat="server" MaxLength="200" />
                    </div>
                </div>
            </asp:PlaceHolder>
            <asp:PlaceHolder runat="server" ID="plcEmail">
                <div class="form-group">
                    ...
                    <div class="editing-form-value-cell">
                        <cms:CMSTextBox ID="txtEmail" runat="server" MaxLength="400" />
                    </div>
                </div>
            </asp:PlaceHolder>
            ...
            <asp:PlaceHolder runat="server" ID="plcCaptcha">
                <div class="form-group">
                    <div class="editing-form-label-cell">
                        <cms:LocalizedLabel CssClass="control-label" ID="lblCaptcha" runat="server" AssociatedControlID="scCaptcha"
                            EnableViewState="false" />
                    </div>
                    <div class="editing-form-value-cell">
