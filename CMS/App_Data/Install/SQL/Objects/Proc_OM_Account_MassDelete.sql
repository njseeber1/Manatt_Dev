	...
	BEGIN			
		...
		BEGIN		
			...
			BEGIN
				...
				BEGIN
					...
					BEGIN		
						...
						BEGIN
                            ...
                            UPDATE OM_Account SET AccountGlobalAccountID = NULL WHERE AccountGlobalAccountID =  @currentMergedSubsidiaryAccountID;
                            UPDATE OM_Account SET AccountSubsidiaryOfID = NULL WHERE AccountSubsidiaryOfID =  @currentMergedSubsidiaryAccountID;
                            UPDATE OM_Account SET AccountMergedWithAccountID = NULL WHERE AccountMergedWithAccountID =  @currentMergedSubsidiaryAccountID;
                            
                            /* Remove all relations */
                            DELETE FROM OM_AccountContact WHERE AccountID = @currentMergedSubsidiaryAccountID;
                            DELETE FROM OM_ContactGroupMember WHERE ContactGroupMemberType=1 AND ContactGroupMemberRelatedID = @currentMergedSubsidiaryAccountID;
                ...
                /* Remove all references */
                UPDATE OM_Account SET AccountGlobalAccountID = NULL WHERE AccountGlobalAccountID =  @currentDeletedAccountID;
                UPDATE OM_Account SET AccountSubsidiaryOfID = NULL WHERE AccountSubsidiaryOfID =  @currentDeletedAccountID;
                UPDATE OM_Account SET AccountMergedWithAccountID = NULL WHERE AccountMergedWithAccountID =  @currentDeletedAccountID;
