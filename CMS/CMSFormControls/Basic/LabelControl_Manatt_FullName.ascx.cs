...
public partial class CMSFormControls_Basic_LabelControl_Manatt_FullName : FormEngineUserControl 
{
    #region "Variables"
  ...
  public override object Value
    {
        ...
        set
        {
            ...
            if (FieldInfo != null)
            {
                mValue = GetLabelText(mValue); // ConvertInputValue(value);
            }
            else
            {
                mValue = GetLabelText(mValue);// ValidationHelper.GetString(value, String.Empty);
            }
        }
    }
