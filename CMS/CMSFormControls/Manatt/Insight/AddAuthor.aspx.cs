...
public partial class CMSFormControls_Manatt_Insight_AddAuthor : CMSModalPage
{
    #region "Variables"
    ...
    private void btnSave_Click(object sender, EventArgs e)
    {
        ...
        {
            var relationships = CustomTableItemProvider.GetItems("Manatt.InsightAuthorRelationship").WhereEquals("InsightId", this.DocumentID).ToList();
            ...
            try
            {
                CustomTableItem relationship = CustomTableItem.New("Manatt.InsightAuthorRelationship");
