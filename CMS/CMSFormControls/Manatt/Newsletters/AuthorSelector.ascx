<%@ Control Language="C#" AutoEventWireup="true" CodeFile="AuthorSelector.ascx.cs" Inherits="CMSFormControls_Manatt_Newsletters_AuthorSelector" %>
    ...
    <cms:CMSUpdatePanel ID="pnlUpdate" runat="server">
        <ContentTemplate>
            ...
            <cms:UniGrid ID="AuthorGrid" runat="server">
                ...
                <GridColumns>
                    <ug:Column Source="Author" Caption="Author" Width="100%" />                    
                </GridColumns>
            </cms:UniGrid>
        </ContentTemplate>
    </cms:CMSUpdatePanel>
