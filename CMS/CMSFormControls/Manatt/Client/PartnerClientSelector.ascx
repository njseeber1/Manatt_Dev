<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PartnerClientSelector.ascx.cs" Inherits="CMSFormControls_Manatt_Client_PartnerClientSelector" %>
...
<div class="cms-bootstrap">
    ...
    <asp:Button runat="server" ID="btnAddRelationship" Text="Add Partner Client" CssClass="btn btn-default" />
    <div style="height: 10px;"></div>
    <cms:CMSUpdatePanel ID="pnlUpdate" runat="server">
        <ContentTemplate>
            <cms:UniGrid ID="PartnerClientGrid" runat="server">
                <GridActions>
