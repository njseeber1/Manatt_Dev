...
public partial class CMSFormControls_Manatt_HRContact_CareerTypeOfficeSelector : FormEngineUserControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if ((TreeNode == null) && (Form != null) && (Form.EditedObject != null))
        {
            ...
            if ((node != null) && (Form.Mode == FormModeEnum.Update))
            {
                ...
                btnAddRelationship.OnClientClick = string.Format("modalDialog('/CMSFormControls/Manatt/HRContact/AddCareerTypeOfficeRelated.aspx?DocumentId={0}&externalControlID={1}', 'AddCareerTypeOfficeRelated', '700', '300'); return false;", TreeNode.DocumentID, ClientID);
        ...
        HRContactGrid.OnAction += HRContactGrid_OnAction;
        HRContactGrid.ShowActionsMenu = false;
        LoadGrid();
    }
    ...
    protected void HRContactGrid_OnAction(string actionName, object actionArgument)
    {
        ...
        {
            string customTableClassName = "Manatt.HRCareerTypeOfficeRelationship";
    ...
    {
        //Grid Data source
        var query = new DataQuery("Manatt.HRCareerTypeOfficeRelationship.ManattHRCareerTypeOfficeRelationshipSelectQuery");
        QueryDataParameters parameters = new QueryDataParameters();
        parameters.Add("@ContactId", TreeNode == null ? 0 : TreeNode.DocumentID);
        query.Parameters = parameters;
        HRContactGrid.DataSource = query.Result;
