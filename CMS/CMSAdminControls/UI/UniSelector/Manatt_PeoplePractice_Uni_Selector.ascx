<%@ Control Language="C#" AutoEventWireup="true" Inherits="CMSAdminControls_UI_UniSelector_Manatt_PeoplePractice_Uni_Selector"
     CodeFile="~/CMSAdminControls/UI/UniSelector/Manatt_PeoplePractice_Uni_Selector.ascx.cs" %>
