<%@ Control Language="C#" AutoEventWireup="True" Inherits="CMSAdminControls_UI_ScreenLock_ScreenLockDialog"  CodeFile="ScreenLockDialog.ascx.cs" %>
...
<div id="screenLockDialog" class="ModalPopupDialog screen-lock-dialog" style="display: none;">
    <asp:Panel ID="pnlScreenLock" runat="server">
        ...
        <asp:Panel runat="server" ID="pnlScreenLockContent" class="dialog-content" Style="width: 400px; height: 200px;">
            <cms:LocalizedLabel runat="server" ID="lblInstructions" CssClass="form-info" />
            <div class="screen-lock-dialog-form">
                ...
                <div class="form-horizontal">
                    ...
                    <div class="form-group" id="usernameBox">
                        <div class="editing-form-label-cell">
                            <cms:LocalizedLabel ID="lblUserName" runat="server" CssClass="control-label" ResourceString="logonform.username" />
                        </div>
                        <div class="editing-form-value-cell">
                    ...
                    <div class="form-group" id="passwordBox">
                        <div class="editing-form-label-cell">
                            <cms:LocalizedLabel ID="lblPassword" runat="server" CssClass="control-label" ResourceString="logonform.password" />
                        </div>
                        <div class="editing-form-value-cell">
                    ...
                    <div class="form-group hide" id="passcodeBox">
                        <div class="editing-form-label-cell">
                            <cms:LocalizedLabel ID="lblPasscode" runat="server" CssClass="control-label" ResourceString="logonform.passcode" />
                        </div>
                        <div class="editing-form-value-cell">
        ...
        <div class="dialog-footer">
            ...
            <cms:CMSButton runat="server" ID="btnScreenLockSignOut" ButtonStyle="Primary" OnClientClick="ScreenLockLogoutUser(); return false;" />
        </div>
    </asp:Panel>
</div>