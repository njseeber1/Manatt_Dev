        ...
        <ContentTemplate>
            <asp:Panel ID="pnlGrid" runat="server" CssClass="ObjectContent">
                <asp:PlaceHolder runat="server" ID="plcTasks">
                    <cms:LocalizedHeading ID="lblTasks" runat="Server" Level="4" />
                    <asp:Panel ID="pnlTaskLinks" runat="server" CssClass="content-block-50">
                        <cms:CMSButton ID="btnAllTasks" runat="Server" EnableViewState="false" OnClick="btnAll_Click" ButtonStyle="Default" />
                        <cms:CMSButton ID="btnNoneTasks" runat="Server" EnableViewState="false" OnClick="btnNone_Click" ButtonStyle="Default" />
                    </asp:Panel>
