...
<div class="CheckoutProcess">
        ...
        <asp:Panel ID="pnlContent" runat="server" CssClass="PageContent">
            ...
            <cms:UniGrid ID="ugSteps" runat="server" ShowObjectMenu="false" PageSize="All">
                ...
                <GridColumns>
                    ...
                    <ug:Column Source="LiveSite" Name="LiveSite" Caption="$CheckoutProcess.ShowOnLiveSite$" Wrap="false" ExternalSourceName="#yesno">
                    </ug:Column>
    ...
    <asp:PlaceHolder ID="plcEdit" runat="server">
        ...
        <asp:Panel ID="pnlEditContent" runat="server" CssClass="PageContent">
            <cms:MessagesPlaceHolder ID="plcMessNew" runat="server" />
            <div class="form-horizontal">
                <div class="form-group">
                    ...
                    <div class="editing-form-value-cell">
                        <cms:LocalizableTextBox ID="txtStepCaption" runat="server" AutomaticMode="false" />
                ...
                <asp:PlaceHolder ID="plcDefaultTypes" runat="server">
                    <div class="form-group">
                        <div class="editing-form-label-cell">
                            <cms:LocalizedLabel CssClass="control-label" ResourceString="CheckoutProcess.lblLiveSite" ID="lblLiveSite" runat="server" EnableViewState="false" />
                        </div>
                        <div class="editing-form-value-cell">
                            <cms:CMSCheckBox ID="chkLiveSite" runat="server" />
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="editing-form-label-cell">
