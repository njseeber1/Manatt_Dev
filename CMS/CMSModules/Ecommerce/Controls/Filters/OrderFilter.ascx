    ...
    <div class="form-horizontal form-filter">
        ...
        <asp:PlaceHolder ID="plcSiteFilter" runat="server">
            <div class="form-group">
                <div class="filter-form-label-cell">
                    <cms:LocalizedLabel CssClass="control-label" ID="lblSites" runat="server" EnableViewState="false" ResourceString="OrderList.SitesLabel" />
                </div>
                <div class="filter-form-value-cell">
                    <cms:SiteSelector ID="siteSelector" runat="server" IsLiveSite="false" PostbackOnDropDownChange="true" AllowAll="true" />
                </div>
            </div>
        </asp:PlaceHolder>
        ...
        <asp:PlaceHolder ID="plcCustomerFilter" runat="server">
            <div class="form-group">
                ...
                <div class="filter-form-value-cell">
                    <cms:CMSTextBox ID="txtCustomerNameOrCompanyOrEmail" WatermarkText="{$com.orders.namecompanyoremail$}" MaxLength="200" runat="server" EnableViewState="false" />
                </div>
            </div>
        </asp:PlaceHolder>
        <%-- Status --%>
