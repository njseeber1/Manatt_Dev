...
<cms:CMSUpdatePanel ID="pnlUpdate" runat="server" UpdateMode="Always">
    <ContentTemplate>
        <cms:UniGrid runat="server" ID="gridElem" OrderBy="OrderDate DESC" FilterLimit="0"
            ...
            OrderCurrencyID,OrderTrackingNumber,OrderNote,OrderSiteID,OrderStatusID"
            ...
            <GridColumns>
                ...
                <ug:Column Name="Date" Source="OrderDate" ExternalSourceName="#userdatetimegmt" Caption="$Unigrid.Order.Columns.OrderDate$"
                    Wrap="false" />
                <ug:Column Name="MainCurrencyPrice" Source="##ALL##" ExternalSourceName="TotalPriceInMainCurrency"
                    Caption="$Unigrid.Order.Columns.OrderTotalPrice$" Sort="OrderTotalPriceInMainCurrency"
                    Wrap="false" CssClass="TextRight" />
                <ug:Column Name="OrderPrice" Source="##ALL##" ExternalSourceName="TotalPriceInOrderPrice"
                ...
                <ug:Column Name="OrderSiteID" Source="OrderSiteID" ExternalSourceName="#sitename" Caption="$general.sitename$"
                    Wrap="false" />
