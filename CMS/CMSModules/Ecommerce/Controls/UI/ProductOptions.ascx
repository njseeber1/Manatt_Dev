    ...
    <ContentTemplate>
        ...
        <cms:UniGrid ID="categoryGrid" runat="server" ObjectType="ecommerce.optioncategorylist" ShowObjectMenu="false" OrderBy="CategoryDisplayName">
            <GridActions>
                ...
                <ug:Action Name="#edit" CommandArgument="CategoryID" Caption="$com.ProductOptions.Edit$"
            ...
            <GridOptions DisplayFilter="false" ShowSelection="true" SelectionColumn="CategoryID" />
        </cms:UniGrid>
        <br />
