            ...
            <div class="form-group">
                ...
                <div class="editing-form-value-cell">
                    <cms:CountrySelector ID="CountrySelector1" runat="server" UseCodeNameForSelection="false"
                        AddSelectCountryRecord="true" DisplayAllItems="true" />
                </div>
            </div>
            <div class="form-group">
                <%--Billing phone--%>
                ...
                <div class="editing-form-value-cell">
                    <cms:CMSTextBox ID="txtBillingPhone" runat="server" MaxLength="100" EnableViewState="false" />
                </div>
            </div>
        </div>
    </asp:PlaceHolder>
        ...
        <div class="BlockContent">
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="editing-form-value-cell">
                        <cms:CMSTextBox ID="txtShippingPhone" runat="server" MaxLength="100" />
                    </div>
                </div>
            </div>
        </div>
