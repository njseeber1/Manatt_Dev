...
<cms:UIForm runat="server" ID="customerForm" ObjectType="ecommerce.customer" AlternativeFormName="NewFromOrder" CssClass="ui-form label-width-125" RedirectUrlAfterCreate="" />
