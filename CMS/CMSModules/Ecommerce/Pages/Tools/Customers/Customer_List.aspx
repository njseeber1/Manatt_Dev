        ...
        <ContentTemplate>
            <cms:UniGrid runat="server" ID="UniGrid" OrderBy="CustomerLastName" IsLiveSite="false"
                ...
                <GridActions>
                    ...
                    <ug:Action Name="hassitebinding" ExternalSourceName="hassitebinding" Caption="$com.customernotboundtosite$"
                        FontIconClass="icon-exclamation-triangle" FontIconStyle="Warning" />
                </GridActions>
                <GridColumns>
