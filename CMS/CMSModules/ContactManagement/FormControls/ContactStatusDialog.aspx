<%@ Page Language="C#" AutoEventWireup="true"  CodeFile="ContactStatusDialog.aspx.cs"
        ...
        <cms:CMSUpdatePanel ID="pnlUpdate" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <cms:UniGrid runat="server" ID="gridElem" OrderBy="ContactStatusDisplayName" ObjectType="om.contactstatus"
                    Columns="ContactStatusID,ContactStatusDisplayName,ContactStatusDescription,ContactStatusSiteID"
