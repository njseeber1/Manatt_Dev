<%@ Page Language="C#" AutoEventWireup="true"  CodeFile="List.aspx.cs" MasterPageFile="~/CMSMasterPages/UI/SimplePage.master"
    Title="Contact status list" Inherits="CMSModules_ContactManagement_Pages_Tools_Configuration_ContactStatus_List"
    Theme="Default" %>
...
<asp:Content ID="cntBody" runat="server" ContentPlaceHolderID="plcContent">
    <cms:UniGrid runat="server" ID="Grid" ObjectType="om.contactstatus" OrderBy="ContactStatusDisplayName"
        Columns="ContactStatusID,ContactStatusDisplayName,ContactStatusSiteID" IsLiveSite="false"
        EditActionUrl="Edit.aspx?statusid={0}" RememberStateByParam="issitemanager">
        <GridActions Parameters="ContactStatusID">
        ...
        <GridColumns>
            <ug:Column Source="ContactStatusDisplayName" Caption="$om.contactstatus.displayname$"
                Wrap="false">
                <Filter Type="text" />
            </ug:Column>
            <ug:Column Source="ContactStatusSiteID" AllowSorting="false" Caption="$general.site$"
