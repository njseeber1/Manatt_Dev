...
<asp:Content ID="cntBody" runat="server" ContentPlaceHolderID="plcContent">
    <asp:PlaceHolder ID="plcDetails" runat="server">
        <asp:Panel runat="server" ID="pnlGen" CssClass="ActivityPanel">
            <cms:LocalizedHeading runat="server" ID="headGeneral" Level="4" EnableViewState="false" IsAnchor="true" ResourceString="om.activity.details.groupgeneral" />
        ...
        <asp:Panel ID="pnlComment" runat="server">
            <cms:LocalizedHeading runat="server" ID="headComment" Level="4" EnableViewState="false" IsAnchor="true" ResourceString="om.activity.activitycomment" />
            <div class="form-horizontal">
                <div class="form-group">
                    <div class="editing-form-label-cell">
                    ...
                    <div class="editing-form-value-cell">
                        ...
                        <div class="control-group-inline">
                            <cms:LocalizedButton ID="btnStamp" runat="server" Enabled="False" ResourceString="om.account.stamp"
