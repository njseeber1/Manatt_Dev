<%@ Control Language="C#" AutoEventWireup="true"  CodeFile="CustomTableSubmit.ascx.cs" Inherits="CMSModules_ContactManagement_Controls_UI_ActivityDetails_CustomTableSubmit" %>
