<%@ Control Language="C#" AutoEventWireup="true"  CodeFile="NewsletterOpen.ascx.cs" Inherits="CMSModules_ContactManagement_Controls_UI_ActivityDetails_NewsletterOpen" %>
