...
<cms:CMSUpdatePanel ID="pnlUpdate" runat="server" UpdateMode="Conditional">
    <ContentTemplate>
        <cms:UniGrid runat="server" ID="gridElem" OrderBy="AccountName" ObjectType="om.accountlist"
            Columns="AccountID,AccountName,PrimaryContactFullName,AccountStatusID,AccountCountryID,AccountMergedWithAccountID,AccountPrimaryContactID,AccountGlobalAccountID,AccountSiteID, AccountCreated"
            ...
            <GridColumns>
                ...
                <ug:Column Source="AccountSiteID" AllowSorting="false" Caption="$general.site$" Wrap="false"
