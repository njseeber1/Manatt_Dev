                ...
                <div class="form-horizontal">
                    <div class="form-group">
                        <div class="editing-form-label-cell">
                            <asp:Label CssClass="control-label" ID="lblCssStyle" runat="server" EnableViewState="false" />
                        </div>
        ...
        <cms:UIPlaceHolder ID="pnlUIOther" runat="server" ModuleName="CMS.Content" ElementName="General.OtherProperties">
            <asp:Panel ID="pnlOther" runat="server">
                ...
                <div class="form-horizontal">
                    <div class="form-group">
                        <div class="editing-form-label-cell">
                            <asp:Label CssClass="control-label" ID="lblNameTitle" runat="server" EnableViewState="false" />
                        </div>
                        <div class="editing-form-value-cell">
                    ...
                    <div class="form-group">
                        <div class="editing-form-label-cell">
                            <asp:Label CssClass="control-label" ID="lblTypeTitle" runat="server" EnableViewState="false" />
                        </div>
                        <div class="editing-form-value-cell">
                    ...
                    <div class="form-group">
                        <div class="editing-form-label-cell">
                            <asp:Label CssClass="control-label" ID="lblCreatedByTitle" runat="server" EnableViewState="false" />
                        </div>
                        <div class="editing-form-value-cell">
                    ...
                    <div class="form-group">
                        <div class="editing-form-label-cell">
                            <asp:Label CssClass="control-label" ID="lblCreatedTitle" runat="server" EnableViewState="false" />
                        </div>
                        <div class="editing-form-value-cell">
                    ...
                    <div class="form-group">
                        <div class="editing-form-label-cell">
                            <asp:Label CssClass="control-label" ID="lblLastModifiedByTitle" runat="server" EnableViewState="false" />
                        </div>
                        <div class="editing-form-value-cell">
                    ...
                    <div class="form-group">
                        <div class="editing-form-label-cell">
                            <asp:Label CssClass="control-label" ID="lblLastModifiedTitle" runat="server" EnableViewState="false" />
                        </div>
                        <div class="editing-form-value-cell">
                    ...
                    <asp:PlaceHolder ID="plcRating" runat="server">
                        ...
                        <div class="editing-form-value-cell control-group-inline">
                            ...
                            <cms:CMSButton ID="btnResetRating" runat="server" ButtonStyle="Default" OnClick="btnResetRating_Click" EnableViewState="false" />
                        </div>
                    </asp:PlaceHolder>
                    <div class="form-group">
                        <div class="editing-form-label-cell">
                            <asp:Label CssClass="control-label" ID="lblNodeIDTitle" runat="server" EnableViewState="false" />
                        </div>
                        <div class="editing-form-value-cell">
                    ...
                    <div class="form-group">
                        <div class="editing-form-label-cell">
                            <asp:Label CssClass="control-label" ID="lblDocIDTitle" runat="server" EnableViewState="false" />
                        </div>
                        <div class="editing-form-value-cell">
                    ...
                    <div class="form-group">
                        <div class="editing-form-label-cell">
                            <asp:Label CssClass="control-label" ID="lblGUIDTitle" runat="server" EnableViewState="false" />
                        </div>
                        <div class="editing-form-value-cell">
                    ...
                    <div class="form-group">
                        <div class="editing-form-label-cell">
                            <asp:Label CssClass="control-label" ID="lblDocGUIDTitle" runat="server" EnableViewState="false" />
                        </div>
                        <div class="editing-form-value-cell">
                    ...
                    <div class="form-group">
                        <div class="editing-form-label-cell">
                            <asp:Label CssClass="control-label" ID="lblAliasPathTitle" runat="server" EnableViewState="false" />
                        </div>
                        <div class="editing-form-value-cell">
                    ...
                    <div class="form-group">
                        <div class="editing-form-label-cell">
                            <asp:Label CssClass="control-label" ID="lblCultureTitle" runat="server" EnableViewState="false" />
                        </div>
                        <div class="editing-form-value-cell">
                    ...
                    <div class="form-group">
                        <div class="editing-form-label-cell">
                            <asp:Label CssClass="control-label" ID="lblNamePathTitle" runat="server" EnableViewState="false" />
                        </div>
                        <div class="editing-form-value-cell">
                    ...
                    <div class="form-group">
                        <div class="editing-form-label-cell">
                            <asp:Label CssClass="control-label" ID="lblPublishedTitle" runat="server" EnableViewState="false" />
                        </div>
                        <div class="editing-form-value-cell">
        ...
        <cms:UIPlaceHolder ID="pnlUIOwner" runat="server" ModuleName="CMS.Content" ElementName="General.Owner">
            <asp:Panel ID="pnlOwner" runat="server" CssClass="NodePermissions">
                ...
                <div class="form-horizontal">
                    <div class="form-group">
                        <div class="editing-form-label-cell">
                            <asp:Label CssClass="control-label" ID="lblOwnerTitle" runat="server" EnableViewState="false" />
                        </div>
                        <div class="editing-form-value-cell">
                ...
                <cms:CMSUpdatePanel ID="ucCache" runat="server">
                    <ContentTemplate>
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                <div class="editing-form-label-cell">
                                    <asp:Label CssClass="control-label" ID="lblCacheMinutes" runat="server" EnableViewState="False" AssociatedControlID="btnClear" />
                                </div>
                                <div class="editing-form-value-cell">
