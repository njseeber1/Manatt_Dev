        ...
        <asp:Panel ID="pnlDelete" runat="server">
            ...
            <asp:PlaceHolder ID="plcCheck" runat="server" EnableViewState="true">
                <cms:CMSPanel ID="pnlDeleteRoot" runat="server" CssClass="form-horizontal" Visible="false">
                    <cms:LocalizedHeading runat="server" ID="LocalizedHeading1" Level="4" IsAnchor="true" ResourceString="root.deletesettingsheader" EnableViewState="false" />
                ...
                <asp:Panel ID="pnlDeleteDocument" runat="server" EnableViewState="false" CssClass="form-horizontal">
                    <cms:LocalizedHeading runat="server" ID="headDeleteDocument" IsAnchor="true" Level="4" EnableViewState="false" />
                    <div class="editing-form-category-fields">
            ...
            <asp:Panel ID="pnlSeo" runat="server" CssClass="form-horizontal">
                <cms:LocalizedHeading runat="server" ID="head" Level="4" IsAnchor="true" ResourceString="ContentDelete.Seo" EnableViewState="false" />
                <cms:CMSUpdatePanel runat="server" ID="pnlAltPath" UpdateMode="Conditional">
                    <ContentTemplate>
                        <div class="editing-form-category-fields">
                            <div class="form-group">
                                <div class="editing-form-label-cell">
                                    <cms:LocalizedLabel CssClass="control-label" AssociatedControlID="chkUseDeletedPath" runat="server" EnableViewState="False"
                                        ID="lblUseDeletedPath" ResourceString="content.delete.usealtpath" DisplayColon="true" />
                                </div>
                                <div class="editing-form-value-cell">
                                    <cms:CMSCheckBox ID="chkUseDeletedPath" runat="server" AutoPostBack="true" EnableViewState="true" />
                                </div>
                            </div>
                                    ...
                                    <div class="form-group">
                                        <div class="editing-form-label-cell">
                                            <cms:LocalizedLabel CssClass="control-label" runat="server" ID="lblAltPath" ResourceString="content.delete.altpath"
                                                DisplayColon="true" ToolTipResourceString="wf.action.deletedoc.altpath.desc" />
                                        </div>
                                        <div class="editing-form-value-cell">
