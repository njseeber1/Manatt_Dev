<%@ Control Language="C#" AutoEventWireup="true"  CodeFile="PageLayouts.ascx.cs" Inherits="CMSModules_DeviceProfile_Controls_PageLayouts" %>

<%@ Register Namespace="CMS.UIControls.UniGridConfig" TagPrefix="ug" Assembly="CMS.UIControls" %>
<%@ Register Src="~/CMSAdminControls/UI/UniGrid/UniGrid.ascx" TagName="UniGrid" TagPrefix="cms" %>
<%@ Register Src="~/CMSModules/DeviceProfile/Controls/LayoutBinding.ascx" TagPrefix="cms" TagName="LayoutBinding" %>
