<%@ Control Language="C#" AutoEventWireup="true" Inherits="CMSModules_Forums_Controls_Layouts_Flat_Thread"  CodeFile="Thread.ascx.cs" %>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr style="border: medium none;">
                                                                    <td style="border: medium none; padding-right: 5px; vertical-align: top;" class="UserAvatar">
                                                                        ...
                                                                        <%--Badges--%>
                                                                        <%#GetNotEmpty(Eval("BadgeDisplayName"), "<div class=\"Badge\">" + Encode(ResHelper.LocalizeString(Convert.ToString(Eval("BadgeDisplayName")))) + "</div>", "<div class=\"Badge\">" + ResHelper.GetString("Forums.PublicBadge") + "</div>", ForumActionType.Badge)%>
                                                                        <%#GetNotEmpty(Eval("BadgeImageURL"), "<div class=\"BadgeImage\"><img alt=\"" + Encode(Eval("BadgeDisplayName")) + "\" src=\"" + GetImageUrl(Encode(Eval("BadgeImageURL"))) + "\" /></div>", "", ForumActionType.Badge)%>
                                                                        <%--Send message, Friendship request--%>
                                                                        <%#IFCompare((EnableMessaging || EnableFriendship) && (ValidationHelper.GetInteger(Eval("PostUserID"), 0) > 0), "<div class=\"PostExtendedActions\">", "")%>
                                                                        <%#IFCompare((EnableMessaging) && (ValidationHelper.GetInteger(Eval("PostUserID"), 0) > 0), "<a class=\"SendMessage\" onclick=\"PrivateMessage(" + Eval("PostUserID") + "); return false;\" title=\"" + ResHelper.GetString("sendmessage.sendmessage") + "\"  href=\"#\"><span>" + ResHelper.GetString("sendmessage.sendmessage") + "</span></a>", "")%>
                                                                        <%#IFCompare((EnableFriendship) && (ValidationHelper.GetInteger(Eval("PostUserID"), 0) > 0), "<a class=\"Friendship\" onclick=\"FriendshipRequest(" + Eval("PostUserID") + "); return false;\" title=\"" + ResHelper.GetString("friends.requestfriendship") + "\" href=\"#\"><span>" + ResHelper.GetString("friends.requestfriendship") + "</span></a>", "")%>
                                                                        <%#IFCompare((EnableMessaging || EnableFriendship) && (ValidationHelper.GetInteger(Eval("PostUserID"), 0) > 0), "</div>", "")%>
                                                                    </td>
