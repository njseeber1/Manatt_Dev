<%@ Control Language="C#" AutoEventWireup="true"
    Inherits="CMSModules_Forums_Controls_Layouts_Flat_SearchResults"  CodeFile="SearchResults.ascx.cs" %>
                                                    ...
                                                    <td style="width: 100%; border: none;" class="Content">
                                                        <asp:PlaceHolder runat="server" ID="plcPost">
                                                            ...
                                                            <span class="PostUser">
                                                                ...
                                                                <%# TimeZoneMethods.ConvertDateTime(ValidationHelper.GetDateTime(Eval("PostTime"), DateTimeHelper.ZERO_TIME), this)%>
                                                            </span>
                                                            <br />
