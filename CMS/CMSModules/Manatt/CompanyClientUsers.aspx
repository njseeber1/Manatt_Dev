<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CompanyClientUsers.aspx.cs" Inherits="CMSModules_ManattAdmin_CompanyClientUsers" %>
...
<body>
    <form id="form1" runat="server">
        <div class="cms-bootstrap">
            ...
            <h3>Manatt Client Users</h3>
            <div><asp:Button ID="btnNew" runat="server" Text="New Client User" OnClick="btnNew_Click" CssClass="btn btn-primary"/></div>
            <br />
