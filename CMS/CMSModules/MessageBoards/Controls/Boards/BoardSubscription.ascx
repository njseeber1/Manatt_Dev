<%@ Control Language="C#" AutoEventWireup="true" Inherits="CMSModules_MessageBoards_Controls_Boards_BoardSubscription"
     CodeFile="BoardSubscription.ascx.cs" %>
        ...
        <div class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="editing-form-value-cell">
                    <cms:CMSTextBox ID="txtEmailAnonymous" MaxLength="250" runat="server" EnableViewState="false" />
            ...
            <div class="form-group">
                ...
                <div class="editing-form-value-cell">
                    <cms:CMSTextBox ID="txtEmailRegistered" runat="server" MaxLength="250"
