<%@ Control Language="C#" AutoEventWireup="true" Inherits="CMSModules_MessageBoards_Controls_Messages_MessageEdit"  CodeFile="MessageEdit.ascx.cs" %>
    ...
    <div class="form-horizontal">
        ...
        <asp:PlaceHolder ID="plcEmail" runat="server">
            <div class="form-group">
                ...
                <div class="editing-form-value-cell">
                    <cms:CMSTextBox ID="txtEmail" runat="server" EnableViewState="false" MaxLength="250" ProcessMacroSecurity="false" /><br />
