    ...
    <asp:Panel ID="pnlUsers" runat="server" CssClass="form-custom-layout">
        <div class="form-horizontal">
            ...
            <asp:PlaceHolder ID="pnlCustomLayout" runat="server">
                <div class="form-group">
                    <div class="editing-form-label-cell">
                        <cms:LocalizedLabel CssClass="control-label" ID="lblEmailFrom" runat="server" EnableViewState="False" ResourceString="bizform_edit_autoresponder.lblEmailFrom" AssociatedControlID="txtEmailFrom" />
                    </div>
                    <div class="editing-form-value-cell">
                        <cms:CMSTextBox ID="txtEmailFrom" runat="server" MaxLength="200" />
                    </div>
                </div>
                <div class="form-group">
                    <div class="editing-form-label-cell">
                        <cms:LocalizedLabel CssClass="control-label" ID="lblEmailSubject" runat="server" EnableViewState="False" ResourceString="general.subject"
