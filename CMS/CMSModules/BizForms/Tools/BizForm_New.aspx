    ...
    <div class="form-horizontal">
        <div class="form-group">
            <div class="editing-form-label-cell">
                <asp:Label CssClass="control-label" runat="server" AssociatedControlID="txtFormDisplayName" ID="lblFormDisplayName" EnableViewState="false" />
            </div>
            <div class="editing-form-value-cell">
                <cms:LocalizableTextBox ID="txtFormDisplayName" runat="server"
                    MaxLength="100" />
                <cms:CMSRequiredFieldValidator ID="rfvFormDisplayName" runat="server" ControlToValidate="txtFormDisplayName:cntrlContainer:textbox" Display="Dynamic" />
            </div>
        </div>
        <div class="form-group">
            <div class="editing-form-label-cell">
