    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            <div class="editing-form-label-cell">
                <cms:LocalizedLabel CssClass="control-label" ID="lblFromEmail" runat="server" EnableViewState="False" ResourceString="bizformgeneral.notification.sender" DisplayColon="True" ToolTipResourceString="bizformgeneral.notification.senderdesc" AssociatedControlID="txtFromEmail" />
            </div>
            <div class="editing-form-value-cell">
                <cms:CMSTextBox ID="txtFromEmail" runat="server" MaxLength="200" />
            </div>
        </div>
        <div class="form-group">
            <div class="editing-form-label-cell">
                <cms:LocalizedLabel CssClass="control-label" ID="lblToEmail" runat="server" EnableViewState="False" ResourceString="bizformgeneral.notification.recipient" DisplayColon="true" ToolTipResourceString="bizformgeneral.notification.recipientdesc" AssociatedControlID="txtToEmail" />
            </div>
            <div class="editing-form-value-cell">
                <cms:CMSTextBox ID="txtToEmail" runat="server" MaxLength="200" />
            </div>
        </div>
        <div class="form-group">
            <div class="editing-form-label-cell">
                <cms:LocalizedLabel CssClass="control-label" ID="lblSubject" runat="server" EnableViewState="False" ResourceString="general.subject" ToolTipResourceString="bizformgeneral.notification.subjectdesc"
