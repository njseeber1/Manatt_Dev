<%@ Control Language="C#" AutoEventWireup="true" Inherits="CMSModules_SocialMarketing_FormControls_LinkedInCompanyAccessToken"  CodeFile="LinkedInCompanyAccessToken.ascx.cs" %>
...
<asp:Panel ID="pnlToken" runat="server">
    ...
    <asp:HiddenField runat="server" ID="hdnTokenSecret" EnableViewState="False" />
