<%@ Control Language="C#" AutoEventWireup="true" Inherits="CMSModules_SmartSearch_Controls_UI_SearchIndex_General"  CodeFile="SearchIndex_General.ascx.cs" %>
<%@ Register Src="~/CMSAdminControls/Basic/DisabledModuleInfo.ascx" TagPrefix="cms" TagName="DisabledModule" %>
<cms:DisabledModule runat="server" ID="ucDisabledModule" SettingsKeys="CMSSearchIndexingEnabled" />
