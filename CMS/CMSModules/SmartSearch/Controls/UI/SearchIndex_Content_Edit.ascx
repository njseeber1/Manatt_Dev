...
<asp:Panel ID="pnlConetnEdit" runat="server">
    ...
    <div class="form-horizontal">
        ...
        <asp:PlaceHolder ID="pnlAllowed" runat="server">
            <div class="form-group">
                <div class="editing-form-label-cell">
                    <cms:LocalizedLabel CssClass="control-label" runat="server" ID="lblInclForums" EnableViewState="false" ResourceString="srch.index.inclforums"
                        DisplayColon="true" AssociatedControlID="chkInclForums" />
                </div>
                <div class="editing-form-value-cell">
                    <cms:CMSCheckBox ID="chkInclForums" runat="server" />
                </div>
            </div>
            <div class="form-group">
                <div class="editing-form-label-cell">
                    <cms:LocalizedLabel CssClass="control-label" runat="server" ID="lblInclBlog" EnableViewState="false" ResourceString="srch.index.inclblog"
                        DisplayColon="true" AssociatedControlID="chkInclBlog" />
                </div>
                <div class="editing-form-value-cell">
                    <cms:CMSCheckBox ID="chkInclBlog" runat="server" />
                </div>
            </div>
            <div class="form-group">
                <div class="editing-form-label-cell">
                    <cms:LocalizedLabel CssClass="control-label" runat="server" ID="lblInclBoards" EnableViewState="false" ResourceString="srch.index.inclboards"
                        DisplayColon="true" AssociatedControlID="chkInclBoards" />
                </div>
                <div class="editing-form-value-cell">
                    <cms:CMSCheckBox ID="chkInclBoards" runat="server" />
                </div>
            </div>
            <div class="form-group">
                <div class="editing-form-label-cell">
