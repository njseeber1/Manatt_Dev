                                    ...
                                    <div class="form-horizontal">
                                        <div class="radio-list-vertical">
                                            ...
                                            <div class="selector-subitem">
                                                <div class="form-group">
                                                    <div class="editing-form-label-cell">
                                                        <asp:Label CssClass="control-label" ID="lblTableName" runat="server" AssociatedControlID="txtTableName" />
                                                    </div>
                                                    <div class="editing-form-value-cell">
                                                ...
                                                <asp:PlaceHolder runat="server" ID="plcPKName">
                                                    <div class="form-group">
                                                        <div class="editing-form-label-cell">
                                                            <asp:Label CssClass="control-label" ID="lblPKName" runat="server" AssociatedControlID="txtPKName" />
                                                        </div>
                                                        <div class="editing-form-value-cell">
