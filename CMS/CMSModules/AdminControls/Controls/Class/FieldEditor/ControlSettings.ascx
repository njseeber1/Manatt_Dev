<%@ Control Language="C#" AutoEventWireup="false"  CodeFile="ControlSettings.ascx.cs"
...
<asp:Panel ID="pnlSettings" runat="server" CssClass="FieldPanel">
    <cms:BasicForm ID="form" runat="server" AllowMacroEditing="true" FieldGroupHeadingLevel="5" />
</asp:Panel>
