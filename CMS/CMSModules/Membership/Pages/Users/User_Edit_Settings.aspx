    ...
    <asp:PlaceHolder ID="plcTable" runat="server">
        <div class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="editing-form-value-cell">
                    <cms:CMSTextBox ID="txtMessageNotifEmail" MaxLength="200" runat="server" />
                </div>
            </div>
            <div class="form-group">
                <div class="editing-form-label-cell">
            ...
            <div class="form-group">
                <div class="editing-form-label-cell">
                    <asp:Label AssociatedControlID="badgeSelector" CssClass="control-label" ID="lblBadge" runat="server" EnableViewState="false" />
                </div>
                <div class="editing-form-value-cell">
            ...
            <div class="form-group">
                <div class="editing-form-label-cell">
                    <asp:Label AssociatedControlID="txtUserActivityPoints" CssClass="control-label" ID="lblUserActivityPoints" runat="server" EnableViewState="false" />
                </div>
                <div class="editing-form-value-cell">
                    <cms:CMSTextBox ID="txtUserActivityPoints" MaxLength="9" runat="server" />
                </div>
            </div>
            <div class="form-group">
                <div class="editing-form-label-cell">
                    <asp:Label AssociatedControlID="txtUserLiveID" CssClass="control-label" ID="lblUserLiveID" runat="server" EnableViewState="false" />
                </div>
                <div class="editing-form-value-cell">
                    <cms:CMSTextBox ID="txtUserLiveID" MaxLength="50" runat="server" />
                </div>
            </div>
            <div class="form-group">
                <div class="editing-form-label-cell">
                    <cms:LocalizedLabel AssociatedControlID="txtFacebookUserID" CssClass="control-label" ID="lblFacebookUserID" runat="server" EnableViewState="false"
                        DisplayColon="true" ResourceString="adm.user.lblfacebookid" />
                </div>
                <div class="editing-form-value-cell">
                    <cms:CMSTextBox ID="txtFacebookUserID" MaxLength="100" runat="server" />
                </div>
            </div>
            <div class="form-group">
                <div class="editing-form-label-cell">
                    <cms:LocalizedLabel AssociatedControlID="txtOpenID" CssClass="control-label" ID="lblUserOpenID" runat="server" EnableViewState="false" DisplayColon="true" />
                </div>
                <div class="editing-form-value-cell">
                    <cms:CMSTextBox ID="txtOpenID" runat="server" MaxLength="450" />
                </div>
            </div>
            <div class="form-group">
                <div class="editing-form-label-cell">
                    <cms:LocalizedLabel AssociatedControlID="txtLinkedInID" CssClass="control-label" ID="lblLinkedInUserID" runat="server" EnableViewState="false"
                        DisplayColon="true" />
                </div>
                <div class="editing-form-value-cell">
            ...
            <div class="form-group">
                <div class="editing-form-label-cell">
                    <asp:Label CssClass="control-label" ID="lblUserForumPosts" runat="server" EnableViewState="false" />
                </div>
                <div class="editing-form-value-cell">
                    <asp:Label ID="lblUserForumPostsValue" CssClass="form-control-text" runat="server" />
                </div>
            </div>
            <div class="form-group">
                <div class="editing-form-label-cell">
                    <asp:Label CssClass="control-label" ID="lblUserBlogPosts" runat="server" EnableViewState="false" />
                </div>
                <div class="editing-form-value-cell">
                    <asp:Label ID="lblUserBlogPostsValue" CssClass="form-control-text" runat="server" />
                </div>
            </div>
            <div class="form-group">
                <div class="editing-form-label-cell">
                    <asp:Label CssClass="control-label" ID="lblUserBlogComments" runat="server" EnableViewState="false" />
                </div>
                <div class="editing-form-value-cell">
                    <asp:Label ID="lblUserBlogCommentsValue" CssClass="form-control-text" runat="server" />
                </div>
            </div>
            <div class="form-group">
                <div class="editing-form-label-cell">
                    <asp:Label CssClass="control-label" ID="lblUserMessageBoardPosts" runat="server" EnableViewState="false" />
                </div>
                <div class="editing-form-value-cell">
                    <asp:Label ID="lblUserMessageBoardPostsValue" CssClass="form-control-text" runat="server" />
                </div>
            </div>
            <div class="form-group">
