<%@ Control Language="C#" AutoEventWireup="true"  CodeFile="Mapping.ascx.cs" Inherits="CMSModules_Membership_Controls_Facebook_Mapping" %>
<%@ Register TagPrefix="cms" TagName="FacebookError" Src="~/CMSModules/Membership/Controls/Facebook/Error.ascx" %>
<%@ Import Namespace="CMS.MembershipProvider.Facebook" %>
